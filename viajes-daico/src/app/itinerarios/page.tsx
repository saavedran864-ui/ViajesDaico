...
export default async function ItinerariosPage() {
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      <h1 className="text-2xl font-serif font-normal text-nude-900 mb-2">Itinerarios</h1>
      <p className="text-nude-500 text-sm mb-8">Seleccioná un viaje para ver o editar su itinerario.</p>
