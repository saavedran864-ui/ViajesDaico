...
export default async function ChecklistGlobalPage() {
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      <h1 className="text-2xl font-serif font-normal text-nude-900 mb-2">Checklists</h1>
      <p className="text-nude-500 text-sm mb-8">Seleccioná un viaje para ver su checklist.</p>
      <div className="grid grid-cols-2 gap-4">
        {viajes?.map(v => (
          <Link key={v.id} href={`/viajes/${v.id}/checklist`}
