  ...
  return (
    <div className="max-w-3xl space-y-5">
      <div className="grid grid-cols-3 gap-4">
        <div className="card">
          <p className="text-xs text-nude-500 mb-1">Presupuesto</p>
          <p className="text-xl font-medium text-nude-900">
            {totalPresupuesto ? formatMonto(totalPresupuesto, viaje.moneda) : '—'}
          </p>
        </div>
        <div className="card">
          <p className="text-xs text-nude-500 mb-1">Gastado</p>
          <p className="text-xl font-medium text-nude-900">{formatMonto(totalGastado, viaje.moneda)}</p>
          {totalPresupuesto > 0 && (
            <div className="mt-2">
              <div className="h-1.5 bg-nude-200 rounded-full">
                <div className="h-1.5 bg-accent rounded-full transition-all"
                  style={{ width: `${Math.min((totalGastado / totalPresupuesto) * 100, 100)}%` }} />
              </div>
              <p className="text-[10px] text-nude-500 mt-1">
        ...
        <div className="card">
          <p className="text-xs text-nude-500 mb-1">Disponible</p>
          <p className={`text-xl font-medium ${totalPresupuesto - totalGastado < 0 ? 'text-red-600' : 'text-nude-900'}`}>
      ...
      <div className="grid grid-cols-3 gap-4">
        {[
          { label: 'Días planificados', value: dias?.length ?? 0, href: `/viajes/${id}/itinerario` },
          ...
          <Link key={label} href={href} className="card hover:border-nude-400 transition-colors">
            <p className="text-2xl font-medium text-nude-900 mb-0.5">{value}</p>
            <p className="text-xs text-nude-500">{label}</p>
          </Link>
        ))}
      </div>
      ...
      {viaje.descripcion && (
        <div className="card">
          <h3 className="text-sm font-medium text-nude-900 mb-2">Descripción</h3>
          <p className="text-sm text-nude-600 leading-relaxed">{viaje.descripcion}</p>
        </div>
      )}
    </div>
  )
