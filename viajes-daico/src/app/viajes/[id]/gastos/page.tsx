    ...
    <div className="max-w-4xl space-y-5">
      ...
      <div className="card">
        <h3 className="text-sm font-medium text-[#1A1D23] mb-3">
          ...
          <span className="ml-2 text-xs text-[#9CA3AF] font-normal">({gastosFiltrados.length})</span>
        </h3>
        <div className="space-y-1">
          ...
          {gastosFiltrados.map(gasto => {
            ...
            return (
              <div key={gasto.id}>
                {editingId === gasto.id ? (
                  <div className="py-3 border-b border-[#E8E9EC] space-y-2">
                  ...
                  <div className="flex items-center gap-3 py-2.5 border-b border-[#E8E9EC] last:border-0 group">
